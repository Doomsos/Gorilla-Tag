...
public class PhotonEvent : IEquatable<PhotonEvent>
{
	...
	// (get) Token: 0x060049D9 RID: 18905 RVA: 0x00185079 File Offset: 0x00183279
	// (set) Token: 0x060049DA RID: 18906 RVA: 0x00185081 File Offset: 0x00183281
	...
	// (get) Token: 0x060049DB RID: 18907 RVA: 0x0018508A File Offset: 0x0018328A
	// (set) Token: 0x060049DC RID: 18908 RVA: 0x00185092 File Offset: 0x00183292
	...
	// Token: 0x060049DD RID: 18909 RVA: 0x0018509B File Offset: 0x0018329B
	private PhotonEvent()
	{
	}

	// Token: 0x060049DE RID: 18910 RVA: 0x001850AA File Offset: 0x001832AA
	...
	// Token: 0x060049DF RID: 18911 RVA: 0x001850E5 File Offset: 0x001832E5
	public PhotonEvent(string eventId) : this(StaticHash.Compute(eventId))
	{
	}

	// Token: 0x060049E0 RID: 18912 RVA: 0x001850F3 File Offset: 0x001832F3
	public PhotonEvent(int eventId, Action<int, int, object[], PhotonMessageInfoWrapped> callback) : this(eventId)
	{
		this.AddCallback(callback);
	}

	// Token: 0x060049E1 RID: 18913 RVA: 0x00185103 File Offset: 0x00183303
	public PhotonEvent(string eventId, Action<int, int, object[], PhotonMessageInfoWrapped> callback) : this(eventId)
	{
		this.AddCallback(callback);
	}

	// Token: 0x060049E2 RID: 18914 RVA: 0x00185114 File Offset: 0x00183314
	~PhotonEvent()
	{
		this.Dispose();
	}

	// Token: 0x060049E3 RID: 18915 RVA: 0x00185140 File Offset: 0x00183340
	...
	// Token: 0x060049E4 RID: 18916 RVA: 0x001851AE File Offset: 0x001833AE
	...
	// Token: 0x060049E5 RID: 18917 RVA: 0x001851D3 File Offset: 0x001833D3
	public void Enable()
	{
		if (this._disposed)
		{
	...
	// Token: 0x060049E6 RID: 18918 RVA: 0x001851FB File Offset: 0x001833FB
	public void Disable()
	{
		if (this._disposed)
		{
	...
	// Token: 0x060049E7 RID: 18919 RVA: 0x00185223 File Offset: 0x00183423
	public void Dispose()
	{
		this._delegate = null;
		if (this._enabled)
	...
	// (add) Token: 0x060049E8 RID: 18920 RVA: 0x00185258 File Offset: 0x00183458
	// (remove) Token: 0x060049E9 RID: 18921 RVA: 0x0018528C File Offset: 0x0018348C
	public static event Action<EventData, Exception> OnError;

	// Token: 0x060049EA RID: 18922 RVA: 0x001852BF File Offset: 0x001834BF
	...
	// Token: 0x060049EF RID: 18927 RVA: 0x001853EC File Offset: 0x001835EC
	...
	// Token: 0x060049F0 RID: 18928 RVA: 0x0018544C File Offset: 0x0018364C
	...
	// Token: 0x060049F1 RID: 18929 RVA: 0x0018546C File Offset: 0x0018366C
	...
	// Token: 0x060049F2 RID: 18930 RVA: 0x001854A8 File Offset: 0x001836A8
	static PhotonEvent()
	{
	...
	// Token: 0x060049F3 RID: 18931 RVA: 0x0018550D File Offset: 0x0018370D
	...
	// Token: 0x060049F4 RID: 18932 RVA: 0x00185525 File Offset: 0x00183725
	public static bool operator ==(PhotonEvent x, PhotonEvent y)
	{
		return EqualityComparer<PhotonEvent>.Default.Equals(x, y);
	}

	// Token: 0x060049F5 RID: 18933 RVA: 0x00185533 File Offset: 0x00183733
	public static bool operator !=(PhotonEvent x, PhotonEvent y)
	{
		return !EqualityComparer<PhotonEvent>.Default.Equals(x, y);
	}

	// Token: 0x060049F6 RID: 18934 RVA: 0x00185544 File Offset: 0x00183744
	...
	// Token: 0x060049F7 RID: 18935 RVA: 0x0018565C File Offset: 0x0018385C
	...
	// Token: 0x060049F8 RID: 18936 RVA: 0x001856AC File Offset: 0x001838AC
	...
	// Token: 0x060049F9 RID: 18937 RVA: 0x001856EF File Offset: 0x001838EF
	...
	// Token: 0x060049FA RID: 18938 RVA: 0x0018570D File Offset: 0x0018390D
	public static PhotonEvent operator -(PhotonEvent photonEvent, Action<int, int, object[], PhotonMessageInfoWrapped> callback)
	{
		if (photonEvent == null)
		{
