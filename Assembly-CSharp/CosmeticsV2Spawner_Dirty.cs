...
public class CosmeticsV2Spawner_Dirty : IDelayedExecListener, ITickSystemTick
{
	...
	// (get) Token: 0x060010D2 RID: 4306 RVA: 0x00059D6F File Offset: 0x00057F6F
	// (set) Token: 0x060010D3 RID: 4307 RVA: 0x00059D76 File Offset: 0x00057F76
	public static bool startedAllPartsInstantiated { get; private set; }

	// Token: 0x1700019C RID: 412
	// (get) Token: 0x060010D4 RID: 4308 RVA: 0x00059D7E File Offset: 0x00057F7E
	// (set) Token: 0x060010D5 RID: 4309 RVA: 0x00059D85 File Offset: 0x00057F85
	public static bool allPartsInstantiated { get; private set; }

	// Token: 0x1700019D RID: 413
	// (get) Token: 0x060010D6 RID: 4310 RVA: 0x00059D8D File Offset: 0x00057F8D
	// (set) Token: 0x060010D7 RID: 4311 RVA: 0x00059D94 File Offset: 0x00057F94
	public static bool completed { get; private set; }

	// Token: 0x1700019E RID: 414
	// (get) Token: 0x060010D8 RID: 4312 RVA: 0x00059D9C File Offset: 0x00057F9C
	// (set) Token: 0x060010D9 RID: 4313 RVA: 0x00059DA4 File Offset: 0x00057FA4
	public bool TickRunning { get; set; }

	// Token: 0x060010DA RID: 4314 RVA: 0x00059DAD File Offset: 0x00057FAD
	...
	// Token: 0x060010DB RID: 4315 RVA: 0x00059DE6 File Offset: 0x00057FE6
	...
	// Token: 0x060010DC RID: 4316 RVA: 0x00059E20 File Offset: 0x00058020
		...
		foreach (GTDirectAssetRef<CosmeticSO> gtdirectAssetRef in allCosmeticsArraySO.sturdyAssetRefs)
		{
			...
			if (info.hasHoldableParts)
			{
				for (int j = 0; j < CosmeticsV2Spawner_Dirty._gVRRigDatas.Count; j++)
				{
					for (int k = 0; k < info.holdableParts.Length; k++)
					{
						...
						{
							CosmeticsV2Spawner_Dirty.AddEachAttachInfoToLoadOpInfosList(cosmeticPart, k, info, j, ref num);
						}
					}
				}
			}
			if (info.hasFunctionalParts)
			{
				for (int l = 0; l < CosmeticsV2Spawner_Dirty._gVRRigDatas.Count; l++)
				{
					for (int m = 0; m < info.functionalParts.Length; m++)
					{
						...
						{
							CosmeticsV2Spawner_Dirty.AddEachAttachInfoToLoadOpInfosList(cosmeticPart2, m, info, l, ref num);
						}
					}
				}
			}
			if (info.hasFirstPersonViewParts)
			{
				for (int n = 0; n < info.firstPersonViewParts.Length; n++)
				{
					...
					{
						CosmeticsV2Spawner_Dirty.AddEachAttachInfoToLoadOpInfosList(cosmeticPart3, n, info, vrRigIndex, ref num2);
					}
				}
			}
			if (info.hasLocalRigParts)
			{
				for (int num4 = 0; num4 < info.localRigParts.Length; num4++)
				{
					CosmeticPart cosmeticPart4 = info.localRigParts[num4];
					...
					{
						CosmeticsV2Spawner_Dirty.AddEachAttachInfoToLoadOpInfosList(cosmeticPart4, num4, info, vrRigIndex, ref num3);
					}
				}
			}
		}
	...
	// Token: 0x060010DD RID: 4317 RVA: 0x0005A1F8 File Offset: 0x000583F8
	...
	// Token: 0x060010DE RID: 4318 RVA: 0x0005A258 File Offset: 0x00058458
	...
	// Token: 0x060010DF RID: 4319 RVA: 0x0005A3FC File Offset: 0x000585FC
	...
	// Token: 0x060010E0 RID: 4320 RVA: 0x0005AAB8 File Offset: 0x00058CB8
	...
	// Token: 0x060010E1 RID: 4321 RVA: 0x0005AC1C File Offset: 0x00058E1C
	...
	// Token: 0x060010E2 RID: 4322 RVA: 0x0005AD8C File Offset: 0x00058F8C
	...
	// Token: 0x060010E3 RID: 4323 RVA: 0x0005ADD0 File Offset: 0x00058FD0
	...
	// Token: 0x060010E4 RID: 4324 RVA: 0x0005B024 File Offset: 0x00059224
	...
	// Token: 0x060010E5 RID: 4325 RVA: 0x0005B1A4 File Offset: 0x000593A4
	...
	{
		// Token: 0x060010E8 RID: 4328 RVA: 0x0005B278 File Offset: 0x00059478
	...
	{
		// Token: 0x060010E9 RID: 4329 RVA: 0x0005B2C4 File Offset: 0x000594C4
