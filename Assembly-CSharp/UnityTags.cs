...
{
	// Token: 0x0600139F RID: 5023 RVA: 0x000714D4 File Offset: 0x0006F6D4
	...
	public static readonly string[] StringValues = new string[]
	{
		...
		"CloudSlingshot_ProjectileTrail",
		"CloudSlingshot_ProjectilePlayerImpactFX",
		"CloudSlingshot_ProjectileSurfaceImpactFX",
		"SnowballProjectile",
		"SnowballProjectileImpactFX",
		"CupidBow_Projectile",
		"CupidBow_ProjectileTrail",
		"CupidBow_ProjectileSurfaceImpactFX",
		"NoCrazyCheck",
		"IceSlingshot_Projectile",
		"IceSlingshot_ProjectileSurfaceImpactFX",
		"IceSlingshot_ProjectileTrail",
		"ElfBow_Projectile",
		"ElfBow_ProjectileSurfaceImpactFX",
		...
		"MoltenSlingshot_ProjectileTrail",
		"MoltenSlingshot_ProjectileSurfaceImpactFX",
		"MoltenSlingshot_ProjectilePlayerImpactFX",
		"SpiderBow_Projectile",
		"SpiderBow_ProjectileTrail",
		"SpiderBow_ProjectileSurfaceImpactFX",
		"SpiderBow_ProjectilePlayerImpactFX",
		"ZoneRoot",
		...
		"DevilBow_Projectile",
		"DevilBow_ProjectileTrail",
		"DevilBow_ProjectileSurfaceImpactFX",
		"DevilBow_ProjectilePlayerImpactFX",
		"Fire_FX",
		"FishFood",
		"FishFoodImpactFX",
		...
		"SamuraiBow_Projectile",
		"SamuraiBow_ProjectileTrail",
		"SamuraiBow_ProjectileSurfaceImpactFX",
		"SamuraiBow_ProjectilePlayerImpactFX",
		"DragonSling_Projectile",
		"DragonSling_ProjectileTrail",
		"DragonSling_ProjectileSurfaceImpactFX",
		"DragonSling_ProjectilePlayerImpactFX",
		"Fireball_Projectile",
		"StealthHandTapFX",
		"EnvPieceTree01",
		"FxSnapPiecePlaced",
		...
		"TrickTreat_Bat",
		"TrickTreat_Bomb",
		"TrickTreat_SurfaceImpact",
		"TrickTreat_Bat_Impact",
		"TrickTreat_Bomb_Impact",
		"GuardianSlapFX",
		"GuardianSlamFX",
		...
		"LeafPile_ImpactFX_Medium",
		"LeafPile_ImpactFX_Small",
		"WoodenSword",
		"WoodenShield",
		"FxBuilderShrink",
		"FxBuilderGrow",
		...
		"RubberBandCar",
		"SnowPile_ImpactFX",
		"Firecrackers_Projectile",
		"PaperAirplaneSquare_Projectile",
		"SmokeBomb_Projectile",
		"ThrowableHeart_Projectile",
		"SunFlowers",
		"RobotCannon_Projectile",
		"RobotCannon_ProjectileImpact",
		"SmokeBomb_ExplosionEffect",
		"FireCracker_ExplosionEffect",
		"GorillaMouth"
	};
