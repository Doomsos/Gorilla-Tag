...
namespace GorillaTag.GuidedRefs
{
	...
	public class GuidedRefTargetMonoComponent : MonoBehaviour, IGuidedRefTargetMono, IGuidedRefMonoBehaviour, IGuidedRefObject
	{
		...
		// (get) Token: 0x060068F8 RID: 26872 RVA: 0x002232DC File Offset: 0x002214DC
		// (set) Token: 0x060068F9 RID: 26873 RVA: 0x002232E4 File Offset: 0x002214E4
		...
		// (get) Token: 0x060068FA RID: 26874 RVA: 0x002232ED File Offset: 0x002214ED
		...
		// Token: 0x060068FB RID: 26875 RVA: 0x0010EB39 File Offset: 0x0010CD39
		protected void Awake()
		{
			((IGuidedRefObject)this).GuidedRefInitialize();
		}

		// Token: 0x060068FC RID: 26876 RVA: 0x002232F5 File Offset: 0x002214F5
		protected void OnDestroy()
		{
			GuidedRefHub.UnregisterTarget<GuidedRefTargetMonoComponent>(this, true);
		}

		// Token: 0x060068FD RID: 26877 RVA: 0x002232FE File Offset: 0x002214FE
