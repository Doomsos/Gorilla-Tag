...
public static class CosmeticsLegacyV1Info
{
	...
	private static readonly Dictionary<string, string> k_v1DisplayNames_to_playFabIds = new Dictionary<string, string>
	{
		...
		{
			"POCKET GORILLA BUN YELLOW",
			"LBABJ."
		},
		{
			"POCKET GORILLA BUN BLUE",
			"LBABK."
		},
		{
			"POCKET GORILLA BUN PINK",
			"LBABL."
		},
		{
			"BONGOS",
		...
		{
			"PAINTBALL FOREST VISOR",
			"LFABP."
		},
		{
			"PAINTBALL SNOW VISOR",
			"LFABQ."
		},
		{
			"PAINTBALL GORILLA VISOR",
			"LFABR."
		},
		{
			"BULGING GOOGLY EYES",
		...
		{
			"CHERRY BLOSSOM BRANCH ROSE GOLD",
			"LMAAB."
		},
		{
			"YELLOW HAND BOOTS",
