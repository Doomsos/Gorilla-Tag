...
public class ChestObjectHysteresis : MonoBehaviour, ISpawnable
{
	...
	// (get) Token: 0x06001CE6 RID: 7398 RVA: 0x00099173 File Offset: 0x00097373
	// (set) Token: 0x06001CE7 RID: 7399 RVA: 0x0009917B File Offset: 0x0009737B
	bool ISpawnable.IsSpawned { get; set; }

	// Token: 0x17000329 RID: 809
	// (get) Token: 0x06001CE8 RID: 7400 RVA: 0x00099184 File Offset: 0x00097384
	// (set) Token: 0x06001CE9 RID: 7401 RVA: 0x0009918C File Offset: 0x0009738C
	ECosmeticSelectSide ISpawnable.CosmeticSelectedSide { get; set; }

	// Token: 0x06001CEA RID: 7402 RVA: 0x00099198 File Offset: 0x00097398
	...
	// Token: 0x06001CEC RID: 7404 RVA: 0x00099226 File Offset: 0x00097426
	private void Start()
	{
	...
	// Token: 0x06001CED RID: 7405 RVA: 0x0009924A File Offset: 0x0009744A
	private void OnEnable()
	{
		ChestObjectHysteresisManager.RegisterCH(this);
	}

	// Token: 0x06001CEE RID: 7406 RVA: 0x00099252 File Offset: 0x00097452
	private void OnDisable()
	{
		ChestObjectHysteresisManager.UnregisterCH(this);
	}

	// Token: 0x06001CEF RID: 7407 RVA: 0x0009925C File Offset: 0x0009745C
