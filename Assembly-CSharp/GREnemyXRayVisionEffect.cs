...
public class GREnemyXRayVisionEffect : MonoBehaviour
{
	...
	// Token: 0x06002C7B RID: 11387 RVA: 0x000F1296 File Offset: 0x000EF496
	private void Start()
	{
		base.InvokeRepeating("UpdateEffect", 0f, 0.5f);
	}

	// Token: 0x06002C7C RID: 11388 RVA: 0x000F12AD File Offset: 0x000EF4AD
	private bool ShouldShowEffect()
	{
		return GRPlayer.GetLocal().HasXRayVision();
	}

	// Token: 0x06002C7D RID: 11389 RVA: 0x000F12B9 File Offset: 0x000EF4B9
