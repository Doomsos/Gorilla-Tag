...
public static class BurstClassInfo
{
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(BurstClassInfo.Index_00004A6D$PostfixBurstDelegate))]
	public unsafe static int Index(lua_State* L)
	{
		return BurstClassInfo.Index_00004A6D$BurstDirectCall.Invoke(L);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(BurstClassInfo.NewIndex_00004A6E$PostfixBurstDelegate))]
	public unsafe static int NewIndex(lua_State* L)
	{
		return BurstClassInfo.NewIndex_00004A6E$BurstDirectCall.Invoke(L);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(BurstClassInfo.NameCall_00004A6F$PostfixBurstDelegate))]
	public unsafe static int NameCall(lua_State* L)
	{
		return BurstClassInfo.NameCall_00004A6F$BurstDirectCall.Invoke(L);
	}
	...
	internal unsafe delegate int Index_00004A6D$PostfixBurstDelegate(lua_State* L);

	internal static class Index_00004A6D$BurstDirectCall
	{
		[BurstDiscard]
		private static void GetFunctionPointerDiscard(ref IntPtr A_0)
		{
			if (BurstClassInfo.Index_00004A6D$BurstDirectCall.Pointer == 0)
			{
				BurstClassInfo.Index_00004A6D$BurstDirectCall.Pointer = BurstCompiler.CompileFunctionPointer<BurstClassInfo.Index_00004A6D$PostfixBurstDelegate>(new BurstClassInfo.Index_00004A6D$PostfixBurstDelegate(BurstClassInfo.Index)).Value;
			}
			A_0 = BurstClassInfo.Index_00004A6D$BurstDirectCall.Pointer;
		}

		private static IntPtr GetFunctionPointer()
		{
			IntPtr result = (IntPtr)0;
			BurstClassInfo.Index_00004A6D$BurstDirectCall.GetFunctionPointerDiscard(ref result);
			return result;
		}
		...
		public unsafe static int Invoke(lua_State* L)
		{
			...
			{
				IntPtr functionPointer = BurstClassInfo.Index_00004A6D$BurstDirectCall.GetFunctionPointer();
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal unsafe delegate int NewIndex_00004A6E$PostfixBurstDelegate(lua_State* L);

	internal static class NewIndex_00004A6E$BurstDirectCall
	{
		[BurstDiscard]
		private static void GetFunctionPointerDiscard(ref IntPtr A_0)
		{
			if (BurstClassInfo.NewIndex_00004A6E$BurstDirectCall.Pointer == 0)
			{
				BurstClassInfo.NewIndex_00004A6E$BurstDirectCall.Pointer = BurstCompiler.CompileFunctionPointer<BurstClassInfo.NewIndex_00004A6E$PostfixBurstDelegate>(new BurstClassInfo.NewIndex_00004A6E$PostfixBurstDelegate(BurstClassInfo.NewIndex)).Value;
			}
			A_0 = BurstClassInfo.NewIndex_00004A6E$BurstDirectCall.Pointer;
		}

		private static IntPtr GetFunctionPointer()
		{
			IntPtr result = (IntPtr)0;
			BurstClassInfo.NewIndex_00004A6E$BurstDirectCall.GetFunctionPointerDiscard(ref result);
			return result;
		}
		...
		public unsafe static int Invoke(lua_State* L)
		{
			if (BurstCompiler.IsEnabled)
			{
				IntPtr functionPointer = BurstClassInfo.NewIndex_00004A6E$BurstDirectCall.GetFunctionPointer();
				if (functionPointer != 0)
				{
					return calli(System.Int32(lua_State*), L, functionPointer);
				}
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal unsafe delegate int NameCall_00004A6F$PostfixBurstDelegate(lua_State* L);

	internal static class NameCall_00004A6F$BurstDirectCall
	{
		[BurstDiscard]
		private static void GetFunctionPointerDiscard(ref IntPtr A_0)
		{
			if (BurstClassInfo.NameCall_00004A6F$BurstDirectCall.Pointer == 0)
			{
				BurstClassInfo.NameCall_00004A6F$BurstDirectCall.Pointer = BurstCompiler.CompileFunctionPointer<BurstClassInfo.NameCall_00004A6F$PostfixBurstDelegate>(new BurstClassInfo.NameCall_00004A6F$PostfixBurstDelegate(BurstClassInfo.NameCall)).Value;
			}
			A_0 = BurstClassInfo.NameCall_00004A6F$BurstDirectCall.Pointer;
		}

		private static IntPtr GetFunctionPointer()
		{
			IntPtr result = (IntPtr)0;
			BurstClassInfo.NameCall_00004A6F$BurstDirectCall.GetFunctionPointerDiscard(ref result);
			return result;
		}
		...
		public unsafe static int Invoke(lua_State* L)
		{
			if (BurstCompiler.IsEnabled)
			{
				IntPtr functionPointer = BurstClassInfo.NameCall_00004A6F$BurstDirectCall.GetFunctionPointer();
				if (functionPointer != 0)
				{
					return calli(System.Int32(lua_State*), L, functionPointer);
				}
