...
{
	// Token: 0x06002291 RID: 8849 RVA: 0x000B4CE6 File Offset: 0x000B2EE6
	public void Awake()
	{
		this._setTeamButton.onPressButton.AddListener(new UnityAction(this.OnSelect));
	}

	// Token: 0x06002292 RID: 8850 RVA: 0x000B4D04 File Offset: 0x000B2F04
	public void OnDestroy()
	{
		this._setTeamButton.onPressButton.RemoveListener(new UnityAction(this.OnSelect));
	}

	// Token: 0x06002293 RID: 8851 RVA: 0x000B4D22 File Offset: 0x000B2F22
