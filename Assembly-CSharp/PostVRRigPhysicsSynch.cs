...
{
	// Token: 0x06004979 RID: 18809 RVA: 0x001815B4 File Offset: 0x0017F7B4
	private void LateUpdate()
	{
		Physics.SyncTransforms();
	}

	// Token: 0x0600497A RID: 18810 RVA: 0x001815C6 File Offset: 0x0017F7C6
	public static void AddSyncTarget(AutoSyncTransforms body)
	{
		PostVRRigPhysicsSynch.k_syncList.Add(body);
	}

	// Token: 0x0600497B RID: 18811 RVA: 0x001815D3 File Offset: 0x0017F7D3
