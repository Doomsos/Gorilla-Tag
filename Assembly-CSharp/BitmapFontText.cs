...
{
	// Token: 0x06001ACA RID: 6858 RVA: 0x0008D737 File Offset: 0x0008B937
	private void Awake()
	{
		this.Init();
		this.Render();
	...
	// Token: 0x06001ACB RID: 6859 RVA: 0x0008D745 File Offset: 0x0008B945
	public void Render()
	{
		this.font.RenderToTexture(this.texture, this.uppercaseOnly ? this.text.ToUpperInvariant() : this.text);
	}

	// Token: 0x06001ACC RID: 6860 RVA: 0x0008D774 File Offset: 0x0008B974
	public void Init()
	{
